 ...
 */
- (void)transformRequest:(NSMutableURLRequest *)request __attribute__((deprecated("Use getRequestHeaders:body: method instead")));
...
- (void)parseResponse:(NSURLResponse *)response __attribute__((deprecated("Use parseResponseHeaders: method instead")));
...
/**
 Return the HTTP headers that the app must add to the request.
 - An alternative to [transformRequest] for apps that use 3rd-party networking libraries.
 
 @param urlString Full URL of the request
 @param httpMethod HTTP method of request object (GET, POST, PUT, DELETE etc )
 @param headers headers of NSURLRequest object before getting APIGuard's headers.
 @param body Body data of the request
 
 @return Dictionary of APIGuard’s headers to add to the HTTP request. This dictionary doesn’t contain any headers that are passed in to this method.
 */
- (nullable NSDictionary<NSString *, NSString *> *)generateHeadersWithURL:(NSString *)urlString httpMethod:(nullable NSString *)httpMethod headers:(nullable NSDictionary *)headers httpBody:(nullable NSData *)body;
...
/**
 @param urlString Full URL of the response.
 @param headers headers of NSURLResponse object.
 @param data NSData object that we get after making a NSURLRequest
 @param code HTTP status code of response object.
 */
- (void)analyzeResponseWithURL:(nullable NSString *)urlString headers:(nullable NSDictionary<NSString *, id> *)headers responseData:(nullable NSData *)data statusCode:(NSInteger)code;
@end
